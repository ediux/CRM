...
namespace CRM.Models
{
	public static class RepositoryHelper
	{
		...
		public static vw_CustomerSummaryRepository Getvw_CustomerSummaryRepository()
		{
			var repository = new vw_CustomerSummaryRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static vw_CustomerSummaryRepository Getvw_CustomerSummaryRepository(IUnitOfWork unitOfWork)
		{
			var repository = new vw_CustomerSummaryRepository();
